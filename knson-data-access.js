(() => {
  ...
  const PROPERTY_LIST_SELECT = String(Schema?.PROPERTY_LIST_SELECT || [
  ...
  const PROPERTY_HOME_SUMMARY_SELECT = String(Schema?.PROPERTY_HOME_SUMMARY_SELECT || [
  ...
  window.KNSN_DATA_ACCESS = {
    ...
    fetchBrowserOverviewCounts,
    fetchBrowserOverviewFallback,
  };
})();
